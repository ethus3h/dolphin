...
QT_MOC_LITERAL(3, 40, 4), // "KUrl"
QT_MOC_LITERAL(4, 45, 3) // "url"
...
void DolphinNewFileMenuObserver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemCreated((*reinterpret_cast< const KUrl(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DolphinNewFileMenuObserver::*_t)(const KUrl & );
...
// SIGNAL 0
void DolphinNewFileMenuObserver::itemCreated(const KUrl & _t1)
{
