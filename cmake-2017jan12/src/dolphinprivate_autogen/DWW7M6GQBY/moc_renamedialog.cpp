...
#include "../../../../../../../../../library/Ember satellite projects/wreathe-file-manager/src/views/renamedialog.h"
...
QT_MOC_LITERAL(1, 13, 16), // "renamingFinished"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 11), // "QList<QUrl>"
QT_MOC_LITERAL(4, 43, 4), // "urls"
QT_MOC_LITERAL(5, 48, 12), // "slotAccepted"
QT_MOC_LITERAL(6, 61, 15), // "slotTextChanged"
QT_MOC_LITERAL(7, 77, 7) // "newName"

    },
    "RenameDialog\0renamingFinished\0\0"
    "QList<QUrl>\0urls\0slotAccepted\0"
    "slotTextChanged\0newName"
};
...
void RenameDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (RenameDialog::*_t)(const QList<QUrl> & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RenameDialog::renamingFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RenameDialog::renamingFinished(const QList<QUrl> & _t1)
{
