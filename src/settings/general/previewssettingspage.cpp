...
void PreviewsSettingsPage::loadSettings()
{
    ...
    m_enabledPreviewPlugins = globalConfig.readEntry("Plugins", QStringList()
                                                     ...
                                                     << QLatin1String("stage_key_thumbnail")
                                                     << QLatin1String("comicbookthumbnail")
                                                     << QLatin1String("cursorthumbnail")
                                                     << QLatin1String("desktopthumbnail")
                                                     << QLatin1String("djvuthumbnail")
                                                     << QLatin1String("marble_thumbnail_shp")
                                                     << QLatin1String("exrthumbnail")
                                                     << QLatin1String("marble_thumbnail_gpx")
                                                     << QLatin1String("htmlthumbnail")
                                                     << QLatin1String("marble_thumbnail_kmz")
                                                     << QLatin1String("marble_thumbnail_kml")
                                                     << QLatin1String("stage_kpr_thumbnail")
                                                     << QLatin1String("karbon_karbon1x_thumbnail")
                                                     << QLatin1String("sheets_xlsx_thumbnail")
                                                     << QLatin1String("sheets_excel_thumbnail")
                                                     << QLatin1String("stage_pptx_thumbnail")
                                                     << QLatin1String("stage_powerpoint_thumbnail")
                                                     << QLatin1String("flow_vsdx_thumbnail")
                                                     << QLatin1String("windowsexethumbnail")
                                                     << QLatin1String("windowsimagethumbnail")
                                                     << QLatin1String("words_docx_thumbnail")
                                                     << QLatin1String("words_msword_thumbnail")
                                                     << QLatin1String("mobithumbnail")
                                                     << QLatin1String("marble_thumbnail_osm")
                                                     << QLatin1String("calligra_odg_thumbnail")
                                                     << QLatin1String("stage_odp_thumbnail")
                                                     << QLatin1String("sheets_ods_thumbnail")
                                                     << QLatin1String("words_odt_thumbnail")
                                                     << QLatin1String("palathumbcreator")
                                                     << QLatin1String("gsthumbnail")
                                                     << QLatin1String("rawthumbnail")
                                                     << QLatin1String("words_rtf_thumbnail")
                                                     << QLatin1String("svgthumbnail")
                                                     << QLatin1String("textthumbnail")
                                                     << QLatin1String("ffmpegthumbs")
                                                     << QLatin1String("karbon_wmf_thumbnail")
                                                     << QLatin1String("words_wpd_thumbnail")
                                                     << QLatin1String("karbon_wpg_thumbnail")
                                                     << QLatin1String("flow_wpg_thumbnail")
